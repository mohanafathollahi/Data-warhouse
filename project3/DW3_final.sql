...
GROUP BY m.y;
---COST: 107, 24 BLOCKS FOR INDEX, USED PREVIOUS INDEXES
...
GROUP BY l.month;
----COST: 2261,
-----COST: 1292, AFTER INDEX OF L_MODEL(16)
-----COST: 1292, AFTER INDEX OF L_AIRPORT(16)
...
---COST:795 INDEX L-AIRPORT AND L-MODEL
